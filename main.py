...
╔═══════════════════════════════════════════════════════════════════════════════════╗
║                                                                                   ║
║          {color(">", "green")} Tentang: {Fore.LIGHTMAGENTA_EX}This Tool Uses Zefoy To Bot TikTok Stats.{Fore.WHITE}                     ║
║          {color(">", "green")} Updates: {Fore.LIGHTMAGENTA_EX}Error Fix & Adjustment --4/15/2022{Fore.WHITE}                          ║
║          {color(">", "green")} Github: {Fore.LIGHTMAGENTA_EX}https://github.com/tahaluindo{Fore.WHITE}                             ║
...
╔═══════════════════════════════╗
║                               ║
║          {color("1", "green")} {Fore.LIGHTMAGENTA_EX}Menu{Fore.WHITE}            ║
