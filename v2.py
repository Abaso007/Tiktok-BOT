...
class Main:
    def __init__(self):
        ...
        cursor.hide()
        txt=self.format(" ヘ（。□°）ヘ ", " ID Video Tiktok :  ")
        YourId=input(txt)
        self.videos = YourId
    ...
    def title(self):
        ...
        while True:
            ...
            try:
                ...
                os.system(
                    f"title ヘ（。□°）ヘ ^| Views: {views} ^| Elapsed Time: {curr_time} ^| v2.1"
                    if os.name == "nt"
                    else ""
                )
                time.sleep(0.5)
                ...
                os.system(
                    f"title ヘ（。□°）ヘ  ^| Views: Lỗi ^| Elapsed Time: {curr_time} ^| v2.1"
                    if os.name == "nt"
                    else ""
                )
        ...
        while True:
            try:
                ...
                if "This service is currently not working" in decryped_answer:
                    ...
                    print(self.format(" ヘ（。□°）ヘ  ",f" Delay: {timer}     "), end="\r")
                    start = time.time()
                    while time.time() < start + timer:
                        print("\r", end="")
                        print(self.format(" ヘ（。□°）ヘ  ", f" Delay: {round((start + timer) - time.time())}       "),end="\r")
                        time.sleep(1)
                    continue
                ...
                if latency > 3:
                    print(self.format(" ヘ（。□°）ヘ  ",f" Gửi views ID: {aweme_id}"))
                ...
                print(self.format(" ヘ（。□°）ヘ  ",f" Date: {timer}    "), end="\r")
                start = time.time()
                while time.time() < start + timer:
                    print("\r", end="")
